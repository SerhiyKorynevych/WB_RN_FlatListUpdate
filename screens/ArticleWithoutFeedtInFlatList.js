...
class ArticleWithoutFeedtInFlatList extends React.Component {
   state ={
       widgetLoaded: false,
       viewID: "54321",
   }
    ...
    render () {
        ...
        return (
            ...
            //     <Header>Here's a Taboola Widget in FlatList</Header>
                <FlatList
                    style={{flex: 1}}
                    data={[{key: 'p1'}, {key: 'p3'}, {key: 'taboola'}, {key: 'p4'}, {key: 'taboolaDark'}, {key: 'p2'},  {key: 'p5'}]}
                    renderItem={({item}) => {
                        switch (item.key) {
                            case 'p1':
                                return p1;
...
export default ArticleWithoutFeedtInFlatList;
